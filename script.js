...
const cellClicked = (e) => {
    ...
    if (!isNaN(moves[id])) {
        ...
        if (currentPlayer == Player1) {
            e.target.style.color = "#76f6ff";
            e.target.style.textShadow = "3px 3px #ebb899";
            ...
            document.getElementById("player").style.textShadow = "1.5px 1.5px #76f6ff";
            document.getElementById("player").style.color = "#ebb899";
            currentPlayer = Player2;
        }
        else {
            e.target.style.color = "#ebb899";
            e.target.style.textShadow = "3px 3px #76f6ff";
            if (isPlayerWon(currentPlayer)) {
            ...
            document.getElementById("player").style.textShadow = "1.5px 1.5px #ebb899";
            document.getElementById("player").style.color = "#76f6ff";
...
function displayResult(player, status) {
    ...
    if (status == "won") {
        ...
        if (player == '♪') {
            if(typeOfgame==1)
            document.getElementById("result").innerText = "yay! you won";
            else{
            document.getElementById("winner").style.textShadow = "1.5px 1.5px #ebb899";
            document.getElementById("winner").style.color = "#76f6ff";
            }
        }
        else {
            if(typeOfgame==1)
            document.getElementById("result").innerText = "You Lost to me, ha!";
            else{
            document.getElementById("winner").style.textShadow = "1.5px 1.5px #76f6ff";
            document.getElementById("winner").style.color = "#ebb899";
            }
        }
    }
    else {
...
function computerTurn() {
    ...
    cell.style.color = "#ebb899";
    cell.style.textShadow = "3px 3px #76f6ff";
    if (isPlayerWon(currentPlayer)) {
        setTimeout(()=>displayResult(Player2, "won"),1000);
        document.getElementById("status").style.visibility = "hidden";
        gameOn = false;
